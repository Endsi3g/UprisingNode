...
export class TransactionsService {
  ...
  async getBalance(userId: string): Promise<number> {
    // Optimize balance calculation by pushing aggregation to the database layer
    // Expected performance impact: Prevents O(N) memory bottleneck and improves response time
    // by keeping calculation DB-side instead of in-memory array reduce
