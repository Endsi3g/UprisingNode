...
export class TransactionsService {
  ...
  async getBalance(userId: string): Promise<number> {
    // ⚡ Bolt Optimization: Use Prisma aggregations instead of loading all transactions into memory.
    // Expected impact: Reduces memory usage from O(N) to O(1) and speeds up calculation by pushing work to the DB.
