...
export class TransactionsService {
  ...
  async getBalance(userId: string): Promise<number> {
    // Performance optimization: Push sum calculation to database to avoid O(N) memory usage and CPU cost
    // Expected impact: Significant reduction in memory and execution time for users with many transactions
