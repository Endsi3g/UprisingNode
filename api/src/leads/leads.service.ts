...
export class LeadsService {
  ...
  // ⚡ Bolt: Calculate potential gains directly in the database instead of O(N) memory filtering
  ...
  // ⚡ Bolt: Get active pipeline leads with limit pushed to the database
