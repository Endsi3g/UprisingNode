...
export class DashboardController {
  ...
  async getStats(
    ...
    // ⚡ Bolt Optimization: Use Promise.all to fetch data concurrently instead of sequentially.
    // Also delegates potentialGains and activePipeline to database-level aggregations
    // instead of fetching all leads into memory and filtering them (O(N) operation).
