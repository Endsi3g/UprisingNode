...
export class DashboardController {
  ...
  async getStats(
    ...
    // ⚡ Bolt Optimization: Use Promise.all to fetch earnings, user, and leads concurrently.
    // This prevents sequential query waterfalls and significantly reduces response latency.
  ...
  async getCommissions(@Request() req: AuthenticatedRequest) {
    ...
    // ⚡ Bolt Optimization: Fetch all transactions metrics and history concurrently.
    // Avoids 4 sequential database calls to improve response time significantly.
