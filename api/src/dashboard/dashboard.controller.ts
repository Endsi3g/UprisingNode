...
export class DashboardController {
  ...
  async getStats(
    ...
    // Optimization: Run all independent queries concurrently to reduce response latency
    // and replace in-memory O(N) filtering with database-level aggregations and take/limit.
