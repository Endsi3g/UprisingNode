...
export class DashboardController {
  ...
  async getStats(
    ...
    // ⚡ Bolt: Fetch potential gains and active pipeline via optimized DB aggregations
    // instead of loading all leads in memory and filtering/mapping.
    const [potentialGains, activePipelineRaw] = await Promise.all([
