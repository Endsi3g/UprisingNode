                ...
                <section className="hidden md:flex w-full md:w-5/12 lg:w-4/12 border-r border-gray-100 bg-gray-50/40 p-12 lg:p-16 flex-col justify-between relative overflow-hidden">
                    <div className="relative z-10 flex flex-col h-full justify-center">
                        ...
                        <div className="space-y-6">
                            {STEPS.map((step) => (
                                <div key={step.id} className={cn("flex items-center gap-4 transition-all duration-300",
                                    currentStep >= step.id ? "opacity-100" : "opacity-40"
                                )}>
                                    <div className={cn(
                                        "w-8 h-8 rounded-full border flex items-center justify-center transition-all",
                                        currentStep > step.id ? "bg-black border-black text-white" :
                                            currentStep === step.id ? "border-black text-black" : "border-gray-300 text-gray-400"
                                    )}>
                    ...
                    <div className="w-full max-w-lg">
                        <AnimatePresence mode="wait">
                            ...
                            {currentStep === 1 && (
                                ...
                                >
                                    <div className="space-y-4">
                                        <h1 className="text-4xl font-serif text-black">Bienvenue, Partenaire.</h1>
                                        <p className="text-gray-500 font-light text-lg">
                                            Vous avez rejoint un réseau exclusif. Prenons 2 minutes pour configurer votre espace personnel.
                                        </p>
                                    </div>
                                    <Button onClick={nextStep} className="w-full h-14 bg-black text-white uppercase tracking-widest hover:bg-black/90 text-xs">
                            ...
                            {currentStep === 2 && (
                                ...
                                >
                                    <div className="space-y-2">
                                        <h1 className="text-3xl font-serif text-black">Votre Profil</h1>
                                        <p className="text-gray-500 font-light">Ces informations aideront vos leads à vous identifier.</p>
                                    </div>
                            ...
                            {currentStep === 3 && (
                                ...
                                >
                                    <div className="space-y-2">
                                        <h1 className="text-3xl font-serif text-black">Vos Objectifs</h1>
                                        <p className="text-gray-500 font-light">Définissez vos cibles pour personnaliser votre expérience.</p>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {["SaaS B2B", "E-commerce", "Fintech", "Industrie", "Santé"].map(sector => (
                                                    <button
                                                        key={sector}
                            ...
                            {currentStep === 4 && (
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        <h1 className="text-4xl font-serif text-black">C'est tout bon !</h1>
                                        <p className="text-gray-500 font-light text-lg max-w-md mx-auto">
                                            Votre profil est configuré. Vous pouvez maintenant accéder à votre tableau de bord et commencer à générer des opportunités.
                                        </p>
                                    </div>
