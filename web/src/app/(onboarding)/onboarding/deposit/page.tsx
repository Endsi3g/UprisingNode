...
export default function FirstDepositPage() {
    ...
    const steps = [
        ...
        { id: 2, title: "Premier Lead", description: "Déposez votre premier contact" },
            ...
            <main className="flex-1 w-full max-w-lg mx-auto px-6 py-32 flex flex-col items-center justify-center">
                ...
                {currentStep === 1 && (
                    <div className="text-center space-y-8 animate-fade-in">
                        ...
                        <div className="pt-8">
                            <Button size="lg" onClick={handleNextStep} className="min-w-[200px]">
                                <span>Commencer</span>
                ...
                {currentStep === 3 && (
                    <div className="text-center space-y-8 animate-fade-in">
                        ...
                        <div className="space-y-2 text-left max-w-xs mx-auto">
                            {["Extraction des données", "Analyse du positionnement", "Génération des angles"].map(
                                (step, i) => (
                                    <div
                                        key={i}
                ...
                {currentStep === 4 && (
                    <div className="text-center space-y-8 animate-fade-in">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-500 font-light leading-relaxed max-w-md mx-auto">
                                Votre premier lead a été analysé avec succès.
                                Retrouvez le rapport complet dans votre Salle de Guerre.
                            </p>
                        </div>
                        ...
                        <div className="pt-8">
                            <Button size="lg" onClick={handleComplete} className="min-w-[240px]">
