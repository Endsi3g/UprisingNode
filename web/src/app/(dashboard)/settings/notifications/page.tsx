          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between group">
              <div>
                ...
                <p className="text-[11px] text-gray-400 leading-relaxed max-w-xs">
                  Réception des analyses de marché et rapports de performance
            ...
            <div className="flex items-center justify-between group">
              <div>
                ...
                <p className="text-[11px] text-gray-400 leading-relaxed max-w-xs">
                  Notifications instantanées pour les événements nécessitant une
                  action immédiate.
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
        ...
        <section className="space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-black transition-colors duration-300">
              <input
                defaultChecked
                className="h-4 w-4 border-black text-black focus:ring-0 rounded-none cursor-pointer mt-0.5"
                id="opt1"
                type="checkbox"
              />
            ...
            <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-black transition-colors duration-300">
              ...
              <label className="cursor-pointer" htmlFor="opt2">
                <p className="text-sm font-serif text-black">
                  Rapport de Salle de Guerre prêt
                </p>
                <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-1">
                  Analyse hebdomadaire • PDF
                </p>
              </label>
            </div>
            <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-black transition-colors duration-300">
              ...
              <label className="cursor-pointer" htmlFor="opt3">
                <p className="text-sm font-serif text-black">
                  Validation de Commission
                </p>
                <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-1">
                  Financier • Cycle mensuel
                </p>
              </label>
            </div>
          </div>
      ...
      <div className="mt-20 pt-12 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex items-center gap-3 text-gray-400">
          ...
          <p className="text-[10px] uppercase tracking-[0.2em]">
            Les changements sont appliqués sous 5 minutes
          </p>
        </div>
