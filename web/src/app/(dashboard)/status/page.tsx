      ...
      <div className="px-6 md:px-12 max-w-7xl mx-auto w-full space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 border border-black/10 flex flex-col justify-between h-40">
            ...
            <div className="flex items-end gap-4">
              <span className="text-5xl font-serif font-bold text-emerald-600">
                99.98%
              </span>
          ...
          <div className="p-6 border border-black/10 flex flex-col justify-between h-40">
            ...
            <div className="flex items-end gap-4">
              <span className="text-5xl font-serif font-bold">45ms</span>
              <span className="text-sm text-emerald-600 mb-2">
                -5ms vs hier
              </span>
            </div>
          </div>
          ...
          <div className="p-6 border border-black/10 flex flex-col justify-between h-40">
            ...
            <div className="flex items-end gap-4">
              <span className="text-5xl font-serif font-bold">0.02%</span>
              <span className="text-sm text-gray-400 mb-2">Stable</span>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-50 p-6 border border-black/5 text-center">
          ...
          <p className="text-sm text-gray-500">
            Aucun incident significatif signalé au cours des 30 derniers jours.
          </p>
        </section>
      </div>
    </main>
