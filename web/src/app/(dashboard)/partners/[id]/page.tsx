...
export default function PartnerProfilePage() {
  ...
  if (!partner)
    return <div className="p-8 font-sans">Partenaire introuvable</div>;
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="w-32 h-32 rounded-full overflow-hidden border border-black/10 shrink-0">
            <img
              src={
                partner.avatar ||
                `https://api.dicebear.com/7.x/initials/svg?seed=${partner.name}`
              }
              alt={partner.name}
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap gap-2">
              <StatusBadge text="actif" variant="success" showDot />
              <span
