        ...
        <div className="bg-white min-h-screen flex flex-col font-sans text-text-main">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full p-6 space-y-8">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-gray-400 text-sm font-mono">#{leadId.slice(0, 8)}</span>
                        </div>
                        <h1 className="text-4xl font-serif text-black">DataFlow Industries</h1>
                        <p className="text-gray-500 mt-2 font-light max-w-2xl">
                            Leader européen de la gestion de données B2B. Cible haute valeur avec besoins d&apos;automatisation critiques.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <DataCard title="Score IA" value="92/100" trend="+14% cette semaine" trendUp={true} />
                    <DataCard title="Valeur Est." value="45 000 €" trend="Commission: 4.5k" trendUp={true} />
                    <DataCard title="Probabilité" value="Haute" trend="Closing < 30j" trendUp={true} />
                    <DataCard title="Concurrents" value="3" trend="Faible menace" trendUp={true} />
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card title="Analyse Stratégique">
                            <div className="prose prose-sm max-w-none font-light text-gray-600 space-y-4">
                                <p>
                                    <strong className="text-black font-medium">Point de Douleur Principal :</strong>
                                    Leur infrastructure actuelle ne supporte pas la montée en charge du Q4.
                                    Les coûts serveurs ont augmenté de 200% sans gain de performance.
                                </p>
                                <p>
                                    <strong className="text-black font-medium">Angle d&apos;Attaque :</strong>
                                    Approche &quot;Réduction de Coûts &quot; couplée à &quot;Scalabilité Infinie&quot;.
                                    Mettre en avant l&apos;architecture distribuée du Node.
                                </p>
                                <div className="bg-gray-50 p-4 border border-gray-100 rounded-sm mt-4">
                                    <h4 className="text-xs uppercase tracking-widest text-black mb-2">Recommandation du Node</h4>
                                    <p className="italic">
                                        &quot;Approchez le CTO directement via LinkedIn avec le script #4.
                                        Mentionnez spécifiquement leurs downtimes de la semaine dernière.&quot;
                                    </p>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card title="Timeline d'Action">
                            <div className="space-y-6 relative border-l border-gray-100 ml-3 pl-8 py-2">
                                <div className="relative">
                                    ...
                                    <p className="text-xs text-gray-400 mb-1">Aujourd&apos;hui, 09:41</p>
                                    <h4 className="text-sm font-medium">Lead Déposé</h4>
                                    <p className="text-sm text-gray-500">Analyse initiale terminée par le Node.</p>
                                </div>
                                <div className="relative">
                                    ...
                                    <p className="text-sm text-gray-500">Envoyer l&apos;email d&apos;intro via Outlook.</p>
                                </div>
                                <div className="relative">
                                    ...
                                    <p className="text-sm text-gray-500">Planifié après réponse positive.</p>
                                </div>
                            </div>
                        </Card>
                    </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 pb-3 border-b border-gray-50 last:border-0 last:pb-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400">Chief Technology Officer</p>
                                    </div>
                                    <span className="ml-auto text-green-600 text-[10px] uppercase font-bold">Cible</span>
                                </div>
                                <div className="flex items-center gap-3 pb-3 border-b border-gray-50 last:border-0 last:pb-0">
                                    <div className="w-8 h-8 rounded-full bg-gray-200" />
                                    <div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between group cursor-pointer hover:bg-white/10 p-2 rounded transition-colors">
                                    <div className="flex items-center gap-3">
                                        <span className="material-symbols-outlined text-gray-400 group-hover:text-white">picture_as_pdf</span>
                                        <span className="text-sm font-light">Audit_Technique_v1.pdf</span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between group cursor-pointer hover:bg-white/10 p-2 rounded transition-colors">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-light">Script_Appel_CTO.docx</span>
                                    </div>
                                    <span className="material-symbols-outlined text-sm opacity-0 group-hover:opacity-100">download</span>
                                </div>
                            </div>
