        ...
        <div className="bg-white min-h-screen flex flex-col font-sans text-text-main">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full p-6 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <DataCard title="Closing Rate" value="34%" trend="+2.4%" trendUp={true} />
                    <DataCard title="Ticket Moyen" value="12.5k €" trend="+500 €" trendUp={true} />
                    <DataCard title="Cycle de Vente" value="14j" trend="-3j" trendUp={true} />
                    <DataCard title="NPS Partenaire" value="9.2" trend="Excellent" trendUp={true} />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <Card title="Évolution des Gains (YTD)">
                        <div className="h-64 bg-gray-50 flex items-center justify-center border-dashed border-2 border-gray-200">
                            <p className="text-gray-400 text-sm">Graphique Interactif (Chart.js)</p>
