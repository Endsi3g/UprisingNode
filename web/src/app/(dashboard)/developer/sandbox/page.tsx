    ...
    <div className="bg-[#1e1e1e] min-h-screen flex flex-col font-mono text-gray-300">
      ...
      <main className="flex-1 flex flex-col md:flex-row h-[calc(100vh-64px)] overflow-hidden">
        ...
        <div className="w-64 bg-[#252526] border-r border-[#333] p-4 flex flex-col gap-2">
          ...
          <button className="text-left px-3 py-2 bg-[#37373d] text-white rounded text-sm">
            Create Lead
          </button>
          <button className="text-left px-3 py-2 hover:bg-[#2a2d2e] rounded text-sm">
            Get User Profile
          </button>
          <button className="text-left px-3 py-2 hover:bg-[#2a2d2e] rounded text-sm">
            List Transactions
        ...
        <div className="flex-1 flex flex-col">
          <div className="h-12 border-b border-[#333] flex items-center px-4 gap-4 bg-[#1e1e1e]">
            ...
            <input
              type="text"
              value="https://api.uprising.node/v1/leads"
          ...
          <div className="flex-1 flex">
            ...
            <div className="flex-1 border-r border-[#333] p-4">
              ...
              <textarea
                className="w-full h-full bg-transparent resize-none focus:outline-none font-mono text-sm text-[#ce9178]"
                defaultValue={`{
  "company": "TechCorp",
