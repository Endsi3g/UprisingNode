            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-sm border border-gray-100">
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  ...
                  <span className="bg-green-100 text-green-700 text-[10px] px-2 py-0.5 rounded uppercase font-bold">
                    Active
                  </span>
                </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-sm border border-gray-100 opacity-60">
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  ...
                  <span className="bg-gray-200 text-gray-600 text-[10px] px-2 py-0.5 rounded uppercase font-bold">
                    Révoquée
                  </span>
                </div>
                <p className="font-mono text-xs text-gray-500">
