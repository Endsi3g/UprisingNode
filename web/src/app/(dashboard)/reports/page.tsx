...
import { MetricDisplay, DataCard, ActionButton } from "@/components/uprising";
import { FileText, Download, TrendingUp, AlertCircle, Calendar } from "lucide-react";

const HISTORY = [
    { id: 1, date: "20 - 26 Janvier 2024", revenue: 4500, highlight: "Meilleure semaine Q1" },
    { id: 2, date: "13 - 19 Janvier 2024", revenue: 2800, highlight: "3 nouveaux clients" },
            ...
            <div className="px-6 md:px-12 max-w-7xl mx-auto w-full space-y-12">
                ...
                <section className="bg-gray-50 p-8 border border-black/5">
                    <div className="flex justify-between items-start mb-8">
                        ...
                        <ActionButton label="Télécharger PDF" icon={Download} />
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="space-y-1">
                            <span className="text-xs uppercase tracking-widest text-gray-400">Revenus Générés</span>
                            <p className="text-4xl font-serif font-bold">1 450 €</p>
                            <span className="text-xs text-emerald-600 font-medium">+12% vs semaine dernière</span>
                        </div>
                        <div className="space-y-1">
                            <span className="text-xs uppercase tracking-widest text-gray-400">Commissions en attente</span>
                            <p className="text-4xl font-serif font-bold">850 €</p>
                            <span className="text-xs text-gray-400">2 deals en closing</span>
                        </div>
                        <div className="space-y-1">
                            <span className="text-xs uppercase tracking-widest text-gray-400">Taux de Conversion</span>
                            <p className="text-4xl font-serif font-bold">24%</p>
                            <span className="text-xs text-emerald-600 font-medium">+2.5 pts</span>
                        </div>
                    </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Vos emails de relance on un taux d'ouverture de 65% cette semaine. C'est 15% de plus que la moyenne des partenaires.
                                </p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h4 className="font-medium text-sm mb-1">Opportunité Manquée</h4>
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Le lead "Tech Solutions SA" n'a pas été contacté depuis plus de 7 jours. Risque de churn estimé à 40%.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                {/* History */}
                <section>
                    <h3 className="text-xl font-serif italic mb-6">Historique des Rapports</h3>
                    <div className="grid grid-cols-1 gap-4">
                        {HISTORY.map((report) => (
                            <div key={report.id} className="group flex items-center justify-between p-6 border border-black/10 hover:border-black/30 transition-all bg-white hover:bg-gray-50 cursor-pointer">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">{report.date}</p>
                                    </div>
                                </div>

                                <div className="flex items-center gap-8 md:gap-16">
                                    <div className="text-right hidden md:block">
                                        <p className="text-xs text-gray-400 uppercase tracking-widest">Revenus</p>
