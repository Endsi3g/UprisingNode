  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-white font-sans p-6 text-center">
      <div className="mb-8 relative">
        ...
        <span className="material-symbols-outlined text-8xl text-green-500 relative z-10">
          verified
        </span>
      </div>
      ...
      <p className="text-gray-400 max-w-md mx-auto mb-12 text-lg font-light">
        Félicitations. La commission de{" "}
        <span className="text-white font-bold">12,450 €</span> a été validée et
        créditée sur votre solde en attente.
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm">
        ...
        <Button
          asChild
          variant="outline"
          className="border-gray-700 text-white hover:bg-gray-900 w-full justify-center"
        >
          <Link href="/transfer">Demander un Virement</Link>
        </Button>
      </div>
