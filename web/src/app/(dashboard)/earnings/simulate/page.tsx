...
export default function EarningsSimulatorPage() {
    ...
    // Calculation
    const estimatedRevenue = Math.round(leadsVolume * BASE_CONVERSION_RATE * CONVERSION_MULTIPLIER * dealValue * COMMISSION_RATE);
        ...
        <div className="bg-white min-h-screen flex flex-col font-sans text-text-main overflow-x-hidden antialiased selection:bg-gray-100 selection:text-black">
            ...
            <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-12">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400 font-sans text-[10px] uppercase tracking-[0.2em]">Projection de Revenus Mensuels</p>
                </div>
                <div className="w-full space-y-16 pt-8">
                    <div className="space-y-6 group">
                        <div className="flex justify-between items-end">
                            ...
                            <span className="font-serif text-3xl md:text-4xl text-black">{leadsVolume}</span>
                        </div>
                    ...
                    <div className="space-y-6 group">
                        <div className="flex justify-between items-end">
                            ...
                            <span className="font-serif text-3xl md:text-4xl text-black">{dealValue.toLocaleString('fr-FR')} €</span>
                        </div>
                        <div className="relative w-full h-6 flex items-center">
                            <input
                                className="w-full bg-transparent z-10 slider-thumb"
                ...
                <div className="border-t border-b border-gray-100 py-12 md:py-16 text-center space-y-6 bg-white relative">
                    ...
                    <p className="text-[10px] uppercase tracking-[0.25em] text-gray-400 font-medium">Vos Revenus Estimés</p>
                    <div className="flex flex-col items-center justify-center gap-2">
                        <h2 className="text-5xl md:text-7xl font-serif text-black tracking-tight">
                            {estimatedRevenue.toLocaleString('fr-FR', { minimumFractionDigits: 2 })} €
                        </h2>
                        <span className="text-xl md:text-2xl text-gray-400 font-serif italic font-light">/ mois</span>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 pt-4">
                    <div className="space-y-3 p-6 border border-gray-50 hover:border-gray-100 transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-2">
                            <span className="material-symbols-outlined text-lg font-light text-gray-400">pie_chart</span>
                            <h3 className="text-sm font-semibold uppercase tracking-widest text-black">Commission de 25%</h3>
                        </div>
                        <div className="h-px w-8 bg-black mb-4"></div>
                        <p className="text-sm text-gray-500 font-light leading-relaxed">
                            Application du modèle de partage de revenus standard sur la totalité du volume d'affaires généré par votre
                            Node.
                        </p>
                    </div>
                    <div className="space-y-3 p-6 border border-gray-50 hover:border-gray-100 transition-colors duration-500">
                        <div className="flex items-center gap-3 mb-2">
                            <span className="material-symbols-outlined text-lg font-light text-gray-400">auto_awesome</span>
                            <h3 className="text-sm font-semibold uppercase tracking-widest text-black">Effet de Levier IA</h3>
                        </div>
                        <div className="h-px w-8 bg-black mb-4"></div>
                        <p className="text-sm text-gray-500 font-light leading-relaxed">
                            L'algorithme de matching optimise la qualification des leads, augmentant le taux de conversion moyen de
                            3.2x par rapport au marché.
                        </p>
                    </div>
                </div>
