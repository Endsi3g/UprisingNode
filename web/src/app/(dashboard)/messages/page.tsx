...
import { ChatBubble, ConversationItem } from "@/components/chat/chat-components";
...
const MOCK_CONVERSATIONS = [
    { id: 1, name: "Support Technique", lastMessage: "Votre ticket #1234 a été résolu", time: "10:30", unread: 2 },
    { id: 2, name: "Maria (Account Manager)", lastMessage: "On fait un point demain ?", time: "Hier", unread: 0 },
    { id: 3, name: "Finance Team", lastMessage: "Virement confirmé pour Janvier", time: "Mar", unread: 0 },
];

const MOCK_MESSAGES = [
    { id: 1, text: "Bonjour, j'ai une question sur ma dernière commission.", isMe: true, time: "10:15" },
    { id: 2, text: "Bonjour ! Je regarde ça tout de suite. Quel est le numéro de transaction ?", isMe: false, time: "10:18" },
    { id: 3, text: "C'est la #TRX-9988", isMe: true, time: "10:20" },
    { id: 4, text: "Merci. Je vois qu'elle est en cours de validation bancaire. Elle devrait arriver demain.", isMe: false, time: "10:25" },
];
