      ...
      <main className="flex-1 w-full max-w-xl mx-auto px-6 py-12 md:py-20 flex flex-col gap-10">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-500 font-sans text-xs font-light max-w-md mx-auto pt-2">
            Veuillez définir un mot de passe robuste pour protéger l'accès à
            votre espace partenaire et valider les accords juridiques.
          </p>
        </div>
            ...
            <div className="group">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="••••••••••••"
                />
                <span className="material-symbols-outlined absolute right-0 text-gray-300 font-light text-lg">
                  lock
                </span>
              </div>
            </div>
          ...
          <div className="pt-2">
            <label className="flex items-start gap-4 group cursor-pointer">
              ...
              <div className="text-sm font-light text-gray-600 leading-relaxed select-none group-hover:text-black transition-colors">
                J'accepte les{" "}
                <span className="underline underline-offset-4 decoration-gray-300 hover:decoration-black transition-all">
