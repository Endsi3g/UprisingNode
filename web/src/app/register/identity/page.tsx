            ...
            <header className="w-full bg-white/95 backdrop-blur-sm fixed top-0 z-40 border-b border-gray-100">
                <div className="px-6 md:px-12 py-6 flex items-center justify-between w-full max-w-[1920px] mx-auto">
                    ...
                    <div className="flex items-center gap-8">
                        <Link href="/login" className="text-[10px] font-medium text-gray-400 hover:text-black uppercase tracking-widest transition-colors">
                            Se connecter
                        </Link>
                    </div>
                </div>
            ...
            <main className="flex-1 w-full flex flex-col md:flex-row min-h-screen pt-[80px]">
                <section className="w-full md:w-5/12 lg:w-4/12 border-b md:border-b-0 md:border-r border-gray-100 bg-gray-50/40 p-12 md:p-16 flex flex-col justify-between min-h-[300px] md:min-h-0 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col justify-center h-full">
                        <span className="material-symbols-outlined text-4xl mb-6 font-thin text-gray-300">format_quote</span>
                    ...
                    <div className="w-full max-w-md space-y-12">
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-end mb-1">
                                <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">Inscription</span>
                                <span className="text-[10px] font-bold text-black uppercase tracking-widest">Étape 1 sur 2</span>
                            </div>
                        ...
                        <form className="space-y-10 pt-4" onSubmit={handleSubmit}>
                            <div className="relative group">
                                <input
                                    ...
                                    required
                                />
                                <label className="floating-label absolute left-0 transition-all duration-300 pointer-events-none text-gray-400" htmlFor="fullname">
                                    Nom complet
                                </label>
                            </div>
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    required
                                />
                                <label className="floating-label absolute left-0 transition-all duration-300 pointer-events-none text-gray-400" htmlFor="email">
                                    Email professionnel
                                </label>
                            </div>
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    required
                                />
                                <label className="floating-label absolute left-0 transition-all duration-300 pointer-events-none text-gray-400" htmlFor="company">
                                    Entreprise
                                </label>
                            </div>
                            ...
                            <div className="pt-6">
                                ...
                                <div className="text-center mt-6">
                                    <p className="text-[9px] text-gray-300 uppercase tracking-widest">En continuant, vous acceptez nos CGU</p>
                                </div>
                            </div>
                        </form>
                    </div>
