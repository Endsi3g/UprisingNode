                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center flex-1 min-h-[60vh]">
                    <div className="lg:col-span-5 space-y-12 fade-in-up">
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-500 font-light leading-relaxed text-lg max-w-md">
                                Notre architecture financière débloque une courbe de rendement exponentielle, maximisant l'impact de chaque nouveau nœud connecté au réseau.
                            </p>
                        </div>
                        <div className="relative pl-8 py-4 border-l-2 border-black/80">
                            ...
                            <span className="block text-6xl md:text-7xl font-serif text-black leading-none mb-2">25%</span>
                            <div className="space-y-1">
                                <p className="text-xs uppercase tracking-widest text-black font-semibold">Commission Perpétuelle</p>
                                <p className="text-sm text-gray-500 font-light leading-snug max-w-xs">
                                    Revenu récurrent généré automatiquement sur l'ensemble de votre volume d'affaires direct et indirect.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:col-span-7 w-full fade-in-up delay-200">
                        <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] p-6 md:p-12">
                            ...
                            <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 400 250">
                                <line stroke="#e5e5e5" strokeWidth="1" x1="0" x2="400" y1="250" y2="250"></line>
                                <line stroke="#e5e5e5" strokeWidth="1" x1="0" x2="0" y1="0" y2="250"></line>
                                <defs>
                                    <linearGradient id="chartGradient" x1="0" x2="0" y1="0" y2="1">
                                        <stop offset="0%" stopColor="#000000" stopOpacity="0.03"></stop>
                                ...
                                <g className="fade-in-up delay-300">
                                    <circle cx="260" cy="140" fill="white" r="3" stroke="black" strokeWidth="1.5"></circle>
                                    <line stroke="#d4d4d4" strokeDasharray="2 2" strokeWidth="1" x1="260" x2="260" y1="140" y2="250"></line>
                                    <text className="text-[10px] font-serif italic fill-black font-medium" x="268" y="135">
                                        Effet de Levier
                                    </text>
                                </g>
                                <g className="fade-in-up delay-300">
                                    <circle cx="380" cy="25" fill="black" r="3" stroke="none"></circle>
                                    <text className="text-[9px] font-sans uppercase tracking-widest fill-black font-semibold" x="360" y="45">
                                        Scale
                                    </text>
                                </g>
                                <text className="text-[9px] font-sans uppercase tracking-[0.2em] fill-gray-400 rotate-0" x="10" y="20">
                                    Revenus Passifs
                                </text>
                                <text className="text-[9px] font-sans uppercase tracking-[0.2em] fill-gray-400" x="360" y="240">
                                    Temps
                                </text>
                            </svg>
                        </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-end pt-8 md:pt-12 mt-auto border-t border-gray-50 fade-in-up delay-300">
                    ...
                    <Link href="/register/identity">
                        <button className="group relative overflow-hidden bg-black text-white px-12 py-5 min-w-[240px] flex items-center justify-center gap-4 transition-all duration-500 hover:bg-gray-900 shadow-sm hover:shadow-xl hover:-translate-y-0.5">
                            <span className="text-xs font-semibold uppercase tracking-[0.25em] relative z-10">Suivant</span>
