...
export function DataCard({
    ...
    return (
        ...
        >
            ...
            {trend && (
                <p className={cn("text-xs flex items-center gap-1", trendUp ? "text-green-600" : "text-gray-500")}>
                    {trendUp && <span className="material-symbols-outlined text-[10px]">arrow_upward</span>}
                    {trend}
                </p>
            )}
        </div>
